...
$(document).ready(function(){svg4everybody(),$("#fullpage").fullpage({anchors:["first","second","third"],navigation:!0,scrollBar:!0,afterLoad:function(n){"third"==n?$.fn.fullpage.setAutoScrolling(!1):$.fn.fullpage.fitToSection()}}),$("[href='#first'], [href='#second']").on("click",function(){$.fn.fullpage.setAutoScrolling(!0)})});